<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('admin.categories.update', $category) }}" class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200/80 dark:border-slate-800 shadow-sm p-6 space-y-5">
                @csrf
                @method('PATCH')
